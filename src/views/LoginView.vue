...
<template>
  <div class="min-h-screen flex items-center justify-center p-4">
    ...
    <div class="fixed inset-0 overflow-hidden pointer-events-none">
      <div class="absolute -top-40 -right-40 w-96 h-96 bg-sage/10 rounded-full blur-3xl"></div>
      <div class="absolute -bottom-40 -left-40 w-96 h-96 bg-rust/10 rounded-full blur-3xl"></div>
    </div>
    ...
    <div class="w-full max-w-md relative">
      ...
      <div class="card p-8 animate-slide-up">
        <h2 class="font-display text-2xl font-medium text-ink-900 mb-6 text-center">Welcome back</h2>
        ...
        <div class="mt-6 text-center">
          <p class="text-ink-500">
            ...
            <router-link to="/signup" class="link font-medium">Create one</router-link>
          </p>
        </div>
      </div>
